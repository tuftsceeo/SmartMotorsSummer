...
iconFrames=[[fb_Train,fb_Play,fb_Setting],[fb_add,fb_delete,fb_smallplay,fb_back],[fb_pause,fb_save,fb_toggle,fb_home]]
iconSize=[32,25,25]
offsets= [(5,20),(102,29),(102,29)] #where you want to display your first icon
